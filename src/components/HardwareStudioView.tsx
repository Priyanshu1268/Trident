    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      {activeTab === 'wiring' && (
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-xs space-y-6">
          <div>
            <h2 className="text-base font-bold text-slate-900">ESP32 & MPU6050 & SIM800L Hardware Pinout</h2>
            <p className="text-xs text-slate-500">
              Schematic wiring instructions for connecting the accelerometer, GSM cellular modem, and status LEDs to the ESP32 devkit.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <h3 className="text-xs font-bold text-slate-900 uppercase">MPU-6050 (I2C Accelerometer / Gyro)</h3>
              <table className="w-full text-xs text-left">
                <thead className="bg-slate-50 text-slate-700 font-bold">
                  <tr>
                    <th className="p-2">MPU6050 Pin</th>
                    <th className="p-2">ESP32 Pin</th>
                    <th className="p-2">Function</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100 text-slate-700">
                  <tr><td className="p-2 font-mono">VCC</td><td className="p-2 font-mono text-emerald-700 font-bold">3.3V</td><td className="p-2">Power supply</td></tr>
                  ...
                  <tr><td className="p-2 font-mono">SCL</td><td className="p-2 font-mono text-blue-700 font-bold">GPIO 22</td><td className="p-2">I2C Clock</td></tr>
                  <tr><td className="p-2 font-mono">SDA</td><td className="p-2 font-mono text-blue-700 font-bold">GPIO 21</td><td className="p-2">I2C Data</td></tr>
                  <tr><td className="p-2 font-mono">INT</td><td className="p-2 font-mono text-amber-700 font-bold">GPIO 19</td><td className="p-2">Hardware Motion Interrupt</td></tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="space-y-3">
              ...
              <table className="w-full text-xs text-left">
                ...
                <tbody className="divide-y divide-slate-100 text-slate-700">
                  <tr><td className="p-2 font-mono">VCC</td><td className="p-2 font-mono text-rose-700 font-bold">4.0V–4.2V (LM2596)</td><td className="p-2">Requires 2A Peak Burst</td></tr>
                  <tr><td className="p-2 font-mono">GND</td><td className="p-2 font-mono text-slate-900 font-bold">Common GND</td><td className="p-2">Shared ground with ESP32</td></tr>
                  <tr><td className="p-2 font-mono">SIM_TXD</td><td className="p-2 font-mono text-indigo-700 font-bold">GPIO 16 (RX2)</td><td className="p-2">UART2 Receive</td></tr>
      ...
      {activeTab === 'firmware' && (
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-xs space-y-4">
          ...
          <div className="bg-slate-950 p-4 rounded-xl text-[11px] font-mono text-slate-200 overflow-x-auto max-h-96">
            <pre id="firmware-code-block">{`// ============================================================================
// SafeRide AI — ESP32 Autonomous Accident Detection Firmware
// MPU6050 (I2C) + SIM800L (UART2) + Cloud Sync
// ============================================================================
...
#define SIM_TX 17
#define SIM_RX 16
#define IMPACT_THRESHOLD_G 3.5
#define ROLLOVER_THRESHOLD_DEG 50
...
void setup() {
  ...
  Serial.println("[SafeRide] ESP32 Sensor & GSM Online");
}
...
void loop() {
  ...
  if (gForce > IMPACT_THRESHOLD_G) {
    Serial.printf("[CRASH DETECTED] G-Force: %.2fg\\n", gForce);
    // Send AT SMS Command to SIM800L
    sim800.println("AT+CMGF=1");
    delay(100);
    sim800.println("AT+CMGS=\\"+919876543210\\"");
    delay(100);
    sim800.printf("EMERGENCY ALERT: SafeRide detected crash (%.2fg) at current GPS location.\\x1A", gForce);
  }
